    ...
    <>
      ...
      {onAskClaude ? (
        <button
          ...
          className="fixed right-4 bottom-20 z-30 flex size-12 items-center justify-center rounded-full border border-led-amber/40 bg-led-amber-deep text-led-amber-soft shadow-[0_0_24px_rgba(255,177,0,0.35)] transition-transform hover:scale-105 lg:hidden"
        >
